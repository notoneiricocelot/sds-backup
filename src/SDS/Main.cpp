...
namespace {
    ...
    void InitializeSerialization() {
        ...
        serde->SetSaveCallback(SDS::SDSInterface::OnGameSaved);
        serde->SetRevertCallback(SDS::SDSInterface::OnRevert);
        serde->SetLoadCallback(SDS::SDSInterface::OnGameLoaded);
    ...
    void InitializePapyrus() {
		...
		if (GetPapyrusInterface()->Register(SDS::RegisterSDSInterface)) {
